...
CREATE TABLE "new_Print" (
    ...
    "user" TEXT NOT NULL,
    CONSTRAINT "Print_user_fkey" FOREIGN KEY ("user") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Tag" (
    ...
    "code" TEXT NOT NULL DEFAULT '',
    "user" TEXT NOT NULL,
    CONSTRAINT "Tag_user_fkey" FOREIGN KEY ("user") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Code" (
    ...
    "code" TEXT NOT NULL DEFAULT '',
    "user" TEXT NOT NULL,
    CONSTRAINT "Code_user_fkey" FOREIGN KEY ("user") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
